...
class TikTokClientV3
{
    ...
    protected $sdkVersion = "tiktok-sdk-php-202501";
    ...
    public function execute(TikTokRequestV3 $request, $accessToken = null)
    {
        [$requestUrl, $request] = $this->buildRequest($request, $accessToken);
        $resp = '';
        try {
            if ($request->httpMethod == 'POST' || $request->httpMethod == 'PUT') {
                $resp = $this->curl_post_put($requestUrl, $request->bodyData, $request->fileParams, $request->headerParams, $request->httpMethod);
            } else {
                $resp = $this->curl_get($requestUrl, $request->udfParams, $request->headerParams);
            }
        } catch (Exception $e) {
...
//		$logger->log($logData);
    ...
    public function buildRequest(TikTokRequestV3 $request, $accessToken = null)
    {
